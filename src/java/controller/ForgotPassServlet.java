 ...
 * @author admin
 */
@WebServlet(name = "ForgotPassServlet", urlPatterns = {"/sendEmail"})
public class ForgotPassServlet extends HttpServlet {
    ...
    private boolean sendOTPEmail(String to, String otp) {
        final String from = "namhhhe182163@fpt.edu.vn"; // Your Gmail address
        final String password = "ptgpjwxscvrvxkmb"; // Your Gmail password (use App Passwords for security)
